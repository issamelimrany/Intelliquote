...
class _ChatPageState extends State<ChatPage> {
  ...
  void initState() {
    ...
    _aiMessages.add(OpenAIChatCompletionChoiceMessageModel(
      content:
          'You need to act as a very wise entity asking the user for at least 5 questions that help identify their mental and physical state, and therefore providing them with a quote that makes them feel better and inspired. This is the only task you need to do. Refuse to answer anything that doesn\'t relate to this purpose, make the questions short and easy to answer. Ask the question one after the other not all at once.',
    ...
    return Scaffold(
      ...
      body: Chat(
        ...
        theme: DefaultChatTheme(
          ...
          secondaryColor: Colors.lightBlueAccent.shade100,
